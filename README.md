...
http {
    ...
    map $remote_addr $validated_xff {
        ...
        172.25.0.4           $http_x_forwarded_for;
        default              "";
    }
    ...
    server {
        ...
        location /proxy2 {
            proxy_pass http://nginx2:80/proxy3;
        }
